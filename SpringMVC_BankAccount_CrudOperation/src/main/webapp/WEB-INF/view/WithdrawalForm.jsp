...
<body>
	<div class="bs-example">
		...
		<form:form name="bank" action="saveWithdrawalAmount"
			...
			<div class="form-group row">
				<form:label path="widrawl_amount" class="col-sm-2 col-form-label">Withdrawal Amount:</form:label>
				<div class="col-sm-10">
					<form:input type="text" path="widrawl_amount" class="form-control"
						name="Account_No" placeholder="Name" required="true"></form:input>
				</div>
			</div>
			<div class="form-group row">
